  ...
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col justify-center items-center gap-4">
        <div>
            ...
            <h3 className='flex items-center gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi! I'm Arman Mkrtichyan <Image src={assets.hand_icon} alt='' className="w-6" /></h3>
            <h1 className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>
                Frontend web developer based in Yerevan</h1>
                <p className='max-w-2xl mx-auto font-Ovo'
                >I am a frontend developer from Armenia</p>
